...
# input_directory = '/home/zhiyu/GNN-Embedding-Leaks-DD/temp_data_DD_0.2_mean_pool_snow_ball/embed_log/'
input_directory = '/home/zhiyu/GNN-Embedding-Leaks-DD/temp_data_DD_0.2_mean_pool_snow_ball/embed_log_correct_setting/'
...
#                     final_test_acc = final_test_acc_match.group(1)
#                     final_test_acc_list.append(float(final_test_acc)*100)


graph_sparsity = pickle.load(open('/home/zhiyu/GNN-Embedding-Leaks-DD/graph_sparsity_DD_new.pkl', 'rb'))
# save no decimal point of graph_sparsity
graph_sparsity = [int(i) for i in graph_sparsity]

final_test_acc_list_DD = pickle.load(open('/home/zhiyu/GNN-Embedding-Leaks-DD/final_test_acc_list_DD_new.pkl', 'rb'))
...
for sparsity_index in range(0, num_sparsity_levels):
    ...
    # Find all logs for this sparsity level and accumulate accuracies
    # filename = f"{sparsity_index}.log"
    # file_path = os.path.join(root, filename)
    ...
    for repeat in range(0, 5):  # Assuming there are 4 repeats for each level
...
plt.savefig('embed_correct_setting_new.png')
print('save figure to embed_correct_setting.png')
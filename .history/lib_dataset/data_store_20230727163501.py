...
class DataStore:
    ...
    def load_raw_data(self, dataset_name):
        ...
        if self.args['is_use_feat']:
            dataset = TUDataset(config.RAW_DATA_PATH + '/'.join((str(self.max_nodes), 'feat')) + '/', name=dataset_name, use_node_attr=True,
            ...
            dataset = TUDataset(config.RAW_DATA_PATH + str(self.max_nodes) + '/', name=dataset_name, use_node_attr=True, 
                                use_edge_attr=False, pre_filter=MyFilter(self.max_nodes),

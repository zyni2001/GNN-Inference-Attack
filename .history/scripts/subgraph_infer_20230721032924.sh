...
cuda=$1
dataset=$2
for dataset_name in AIDS # AIDS, ENZYMES, DD
do
  for sample_node_ratio in 0.4 # 0.2 0.4 0.6 0.8
    do
      for target_model in mincut_pool # diff_pool, mincut_pool, mean_pool
        do
          for sample_method in random_walk # random_walk, snow_ball, forest_fire
            do

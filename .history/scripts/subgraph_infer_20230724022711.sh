        ...
        do
          for sample_method in ${sample_methods[@]}
            do
              ...
              python main.py --dataset $dataset_name --shadow_dataset $dataset_name --exp 'subgraph_infer' --cuda $gpu_id --is_train_target_model False --is_use_shadow_model False --num_runs 10 --target_model $target_model --is_gen_attack_data False --train_sample_method $sample_method --test_sample_method $sample_method --sample_node_ratio $sample_node_ratio --feat_gen_method ['element_l2'] --attack 'subgraph_infer_2' 2>&1 | tee "./temp_data/log/$dataset_name.$target_model.$sample_node_ratio$sample_method.log" &

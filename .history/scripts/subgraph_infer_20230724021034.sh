        ...
        do
          for sample_method in ${sample_methods[@]}
            do
              ...
              python main.py --is_train_target_model False --is_use_shadow_model False --is_gen_attack_data False --shadow_dataset $dataset_name --exp 'subgraph_infer' --attack 'subgraph_infer_2' --dataset $dataset_name --target_model $target_model --sample_node_ratio $sample_node_ratio  --train_sample_method $sample_method --test_sample_method $sample_method --cuda $gpu_id 2>&1 | tee "./temp_data/log/$dataset_name.$target_model.$sample_node_ratio$sample_method.log" &
